      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4" style={{ backgroundColor: '#1a1a2e' }}>
              <span className="text-2xl font-bold" style={{ color: '#4aa0de' }}>SIA</span>
            </div>
            <h1 className="text-3xl font-bold text-gray-800">Sistema de gestión académica</h1>
          </div>
            ...
            {({ handleSubmit }) => (
              <Form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3 rounded-lg border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
                >
