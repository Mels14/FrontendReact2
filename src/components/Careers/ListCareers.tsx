...
import { getCareers, deleteCareer } from "../../services/careersService";
...
const ListCareers = () => {
  ...
  const handleDelete = async (id: string) => {
    Swal.fire({
      ...
      text: "¿Está seguro de querer eliminar esta carrera?",
      icon: "warning",
      ...
      <div className="flex flex-col gap-9">
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark flex justify-between items-center">
            <h3 className="font-medium text-black dark:text-white">Carreras</h3>
            <a href="/carreras/crear" className="bg-primary text-white px-4 py-2 rounded-md text-sm">
              + Nueva carrera
            </a>
          </div>
